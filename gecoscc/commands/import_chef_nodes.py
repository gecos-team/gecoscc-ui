...
from gecoscc.utils import _get_chef_api, register_or_updated_node, update_node, SOURCE_DEFAULT, sanitize
...
class Command(BaseCommand):
    ...
    usage = "usage: %prog config_uri import_chef_nodes --administrator user --key file.pem"
