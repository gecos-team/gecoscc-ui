...
class Command(BaseCommand):
    ...
    usage = ("usage: %prog create_nodes --number 100000 "
             ...
             "--copy-computer-id 1234567890abcdef12345678 "
             "--gecoscc-url http://localhost --gecoscc-username admin "
             "--gecoscc-password admin")
    ...
    def command(self):
        ...
        for i in range(number_nodes):
            ...
            for attr in list(node.to_dict().keys()):
                if hasattr(node, attr) and attr != 'name':
                    if attr == 'automatic':
                        ...
                        automatic_dict['ohai_gecos']['users'] = [
                            {'username': user1,
                             'home': '/home/%s' % user1,
                             'gid': 1000,
                             'sudo': False,
